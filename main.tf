...
data "azurerm_resource_group" "this" {
  name = var.virtual_desktop_scaling_plan_resource_group_name
}

# autoscale settings https://docs.microsoft.com/azure/virtual-desktop/autoscale-scenarios

# scaling plan for pooled pools
resource "azurerm_virtual_desktop_scaling_plan" "this" {
  count = var.virtual_desktop_scaling_plan_type == "Pooled" ? 1 : 0
...
resource "azapi_resource" "this" {
  ...
  body = {
    properties = {
      ...
      exclusionTag = var.virtual_desktop_scaling_plan_exclusion_tag,
      description  = var.virtual_desktop_scaling_plan_description,
...
resource "azurerm_role_assignment" "this" {
  ...
  scope                                  = var.virtual_desktop_scaling_plan_type == "Pooled" ? azurerm_virtual_desktop_scaling_plan.this[0].id : azapi_resource.this[0].id
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  target_resource_id             = var.virtual_desktop_scaling_plan_type == "Pooled" ? azurerm_virtual_desktop_scaling_plan.this[0].id : azapi_resource.this[0].id
